...
- [x] **T01: Restructure docker-compose.yml with full profile and add auth/observability services** `est:30m`
...
- [x] **T02: Create Prometheus scrape config and Grafana provisioning** `est:20m`
...
- [x] **T03: Start full stack and verify all services reach healthy state** `est:15m`
